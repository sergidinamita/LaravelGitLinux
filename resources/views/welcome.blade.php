                    ...
                    <a href="" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <div class="row">
                                ...
                                <div class="col mt-4">
                                    <p class="text-xl">TRIA LA TEVA COMPAÑIA :</p>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                PREGUTNAS DE LA COMPAÑIA QUE S'HAN CONTESTAT :
                            </p>
                        </div>
                    </a>
                    ...
                    <a href="" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <div class="row">
                                ...
                                <div class="col mt-4">
                                    <p class="text-xl">Respostas contestadas fins ara :</p>
                                </div>
                            </div>
                    ...
                    <a href="" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <div class="row">
                                ...
                                <div class="col mt-4">
                                    <p class="text-xl">TRIA LA TEVA EMPRESA</p>
                                    <select id="selectEmpresa" class="form-select form-select-lg mb-3" aria-label="Large select example">
                                        <option value="" selected>Seleccionar empresa</option>
                                        @foreach ($empresas as $empresa)
                                        <option value="{{ $empresa->id_empresa }}">{{ $empresa->nombre }}</option>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                LA EMPRESA TE AQUESTA PREGUNTAS RESPOSES FINS ARA:
                            </p>
                            <p id="contador_preguntas" >count</p>
                        </div>
                    </a>
                    ...
                    <a href="" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <div class="row">
                                ...
                                <div class="col mt-4">
                                    <p class="text-xl">ANAR AL HOME DE ENQUESTAS</p>
                                </div>
                            </div>
                        </div>
                    </a>
